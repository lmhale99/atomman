...
class SemiDiscretePeierlsNabarro(object):
    ...
    def __set(self, x, disregistry, gamma, axes, K_tensor, **kwargs):
        ...
        cdiffgradient : bool, optional
            Flag indicating if the dislocation density for the gradient energy
            component is computed with central difference (True) or simply
        ...
        self.__cdiffgradient = kwargs.get('cdiffgradient', True)
    ...
    def solve(self, **kwargs):
        """
        Solves the semi-discrete Peierls-Nabarro dislocation disregistry
        through energy minimization using the set class properties.  All
        parameters are optional keyword arguments that replace the class
        properties.
        ...
        self.__cdiffgradient = kwargs.pop('cdiffgradient', self.__cdiffgradient)
    ...
    def gradient_energy(self, x=None, disregistry=None):
        ...
        Computes the gradient energy correction using beta coefficients.
            ...
            E_gradient = Σ_j β_lj / 4 Σ_i ρ_l[i]² Δx
        ...
        -------
        float
            The gradient energy for the dislocation.
        """
        # Default values are class properties
        if x is None:
            x = self.__x
    ...
    def total_energy(self, x=None, disregistry=None):
        ...
        Computes the total energy for the dislocation.
            ...
            E_total = E_elastic + E_misfit + E_stress + E_gradient + E_nonlocal
    ...
    def load(self, model, gamma=None):
        ...
        self.__cdiffgradient = params['cdiffgradient']
    ...
    def model(self, length_unit='Angstrom', energy_unit='eV',
        ...
        """
        model = DM()
        model['semi-discrete-Peierls-Nabarro'] = sdpn = DM()
