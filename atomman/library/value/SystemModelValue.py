...
class SystemModelValue(Value):
    ...
    @property
    def prop_unit(self) -> Optional[dict]:
        """dict or None: The units to use for property values when building the model"""
        return self.__prop_unit
    ...
    def build_model_value(self):
        ...
        return self.value.dump('system_model', prop_unit=self.__prop_unit)[self.loadkey]
