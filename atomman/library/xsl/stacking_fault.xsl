...
<xsl:stylesheet version="1.0" 
  ...
  <xsl:template match="stacking-fault">
    <div>
      ...
      <h1>Stacking fault parameter set</h1>
      <ul>
        ...
        <li>
          <b><xsl:text>atomman StackingFault defect parameters:</xsl:text></b>
          <ul class="aslist">
            <li><xsl:text>hkl: "</xsl:text><xsl:value-of select="calculation-parameter/hkl"/><xsl:text>"</xsl:text></li>
            <li><xsl:text>a1vect_uvw: "</xsl:text><xsl:value-of select="calculation-parameter/a1vect_uvw"/><xsl:text>"</xsl:text></li>
            <li><xsl:text>a2vect_uvw: "</xsl:text><xsl:value-of select="calculation-parameter/a2vect_uvw"/><xsl:text>"</xsl:text></li>
