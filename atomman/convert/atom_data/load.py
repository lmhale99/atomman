...
def load(data, pbc=(True, True, True), atom_style='atomic', units='metal'):
    ...
    if atomsstart is not None:
        ...
        system = table.load(data, box=system.box, system=system, prop_info=prop_info,
                                  skiprows=atomsstart, nrows=natoms)
    else:
    ...
    if velocitiesstart is not None:
        ...
        system = table.load(data, box=system.box, system=system,
                            prop_info=prop_info,
